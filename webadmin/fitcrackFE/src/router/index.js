...
const rainbowTablesDetail = () => import('@/components/rainbowTables/rainbowTablesDetailView.vue')
...
const appRoutes = [
  ...
  {
    path: '/rainbowTables/:id',
    name: 'rainbowTablesDetail',
    component: rainbowTablesDetail
  },
  {
    path: '/markovChains',
    name: 'markovChains',
